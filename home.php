<div class="content py-3">
    <div class="card rounded-0 shadow">
        <div class="card-body">
            <h3>Bienvenue sur le système de gestion d'un restaurant</h3>
            <hr>
            <div class="col-12">
                        ...
                        <div class="card text-dark">
                            <div class="card-body">
                                <div class="w-100 d-flex align-items-center">
                                    ...
                                    <div class="col-auto flex-grow-1">
                                        <div class="fs-5"><b>Repas/Produits</b></div>
                                        <div class="fs-6 text-end fw-bold">
                                            <?php 
                        ...
                        <div class="card text-dark">
                            <div class="card-body">
                                <div class="w-100 d-flex align-items-center">
                                    ...
                                    <div class="col-auto flex-grow-1">
                                        <div class="fs-5"><b>Total des ventes</b></div>
<!--                                        <div class="fs-6 text-end fw-bold">-->
<!--                                            --><?php
//                                            $stock = 0;
                        ...
                        <div class="card text-dark">
                            <div class="card-body">
                                <div class="w-100 d-flex align-items-center">
                                    ...
                                    <div class="col-auto flex-grow-1">
                                        <div class="fs-5"><b>Ventes du jour</b></div>
                                        <div class="fs-6 text-end fw-bold">
                                            <?php 
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <table class="table table-striped table-hover table-bordered" id="inventory">
                            ...
                            <thead>
                                <tr>
                                    <th class="py-0 px-1">Menus</th>
<!--                                    <th class="py-0 px-1">Product Code</th>-->
                                    <th class="py-0 px-1">Nom du Repas</th>
