...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | Food management System</title>
    ...
    <style>
        ...
        @media screen{
            body{
                /*background-image:url('./images/pharmacie.jpg') !important;*/
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'products')? 'active' : '' ?>" href="./?page=products">Repas/Produits</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'sales_report')? 'active' : '' ?>" href="./?page=sales_report">Rapport des ventes</a>
                    </li>
                    <?php if($_SESSION['type'] == 1): ?>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./?page=maintenance">Menus</a>
                    </li>
                    <?php endif; ?>
