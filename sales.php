        ...
        <div class="w-100 h-100 d-flex flex-column">
            <div class="row">
                ...
                <div class="col-4 d-flex justify-content-end">
                    <button class="btn btn-sm btn-primary rounded-0 " id="transaction-save-btn" type="button">Sauvegarder
                    </button>
                </div>
                ...
                <form action="" class="h-100" id="transaction-form">
                    <div class="w-100 h-100 mx-0 row row-cols-2 bg-dark">
                        <div class="col-8 h-100 pb-2 d-flex flex-column">
                            <div>
                                <h3 class="text-light">Sélectionner un Repas</h3>
                            </div>
                            <div class="flex-grow-1 d-flex flex-column bg-light bg-opacity-50">
                                <div class="form-group py-2 d-flex border-bottom">
                                    <label for="search" class="col-auto px-2 fw-bolder text-light">Recherche</label>
                                    <div class="flex-grow-1 col-auto pe-2">
                                        <input type="text" autocomplete="off"
                                               class="form-control form-control-sm rounded-0" id="search">
                                    </div>
                                </div>
                                <div>
                                    <table class="table table-hover table-striped bg-light mb-0">
                                        ...
                                        <thead>
                                        <tr>
                                            <th class="py-0 px-1">Menus/Produits</th>
<!--                                            <th class="py-0 px-1">Product Code</th>-->
                                            <th class="py-0 px-1">Repas</th>
                                            <th class="py-0 px-5">Prix</th>
                                    ...
                                    <div class="h-100 overflow-auto" style="height:60vh !important ">
                                        <table class="table table-hover table-striped bg-light" id="plist">
                                            ...
                                            while ($row = $qry->fetch_assoc()):
                                                ...
                                                $qty = $qty > 0 ? $qty : 0;
                                                ?>
                                                <tr class="item <?php echo $qty < 50 ? "bg-danger bg-opacity-25" : '' ?>"
...
<!--                                                    <td class="td py-0 px-1 pcode">--><?php //echo $row['product_code'] ?><!--</td>-->
                                                    ...
                                                    <td class="td py-0 px-1 text-end price"><?php echo format_num($row['price']) ?> XAF</td>
                                ...
                                <div class="w-100 flex-grow-1">
                                    <div class="h-100 d-flex w-100 flex-column">
                                        <div class="d-flex">
                                            ...
                                            <div class="col-auto">
                                                <button class="btn btn-danger rounded-0 py-0" type="button"
                                                        id="remove-item" disabled onclick="remove_item()"><i
                                        ...
                                        <div>
                                            <table class="table table-hover table-bordered table-striped bg-light m-0">
                                                ...
                                                <th class="py-0 px-1 text-center">Repas</th>
                                        ...
                                        <div class="flex-grow-1">
                                            <div style="height:55vh !important"
                                                 class="overflow-auto bg-light bg-opacity-75">
...
<!--                                                <div class="flex-grow-1 bg-light fs-6 fw-bolder text-end px-2"-->
<!--                                                     id="subTotal">0.00-->
<!--                                                </div>-->
<!--                                            </div>-->
<!--                                            <div class="w-100 mx-0 d-flex pb-1 align-items-center">-->
<!--                                                <div class="col-4 pe-2 fs-6 fw-bolder text-light">Tax (12%)<small>Inclusive</small>-->
<!--                                                </div>-->
<!--                                                <div class="flex-grow-1 bg-light fs-6 fw-bolder text-end px-2" id="tax">-->
<!--                                                    0.00-->
<!--                                                </div>-->
<!--                                            </div>-->
                                            <div class="w-100 mx-0 d-flex pb-1">
                                                <div class="col-4 pe-2 fs-6 fw-bolder text-light">Montant Total</div>
                                                <div class="flex-grow-1 bg-light fs-6 fw-bolder text-end px-2"
                                                     id="total">0.00
                                                </div>
                                            </div>
    ...
    $(function () {
        ...
        $('#plist tbody tr').click(function () {
            ...
            ntr.append('<td class="py-0 px-1 align-middle"><div class="fs-6 mb-0 lh-1">' + pcode + '<br/>' +
                ...
                '</td>');
            ntr.append('<td class="py-0 px-1 align-middle text-end total">' + parseFloat(price).toLocaleString('en-US', {
                style: 'decimal',
                maximumFractionDigits: 2
            }) + '</td>')
