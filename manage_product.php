...
<!--                        <label for="product_code" class="control-label">Code</label>-->
                        <input type="hidden" name="product_code" autofocus id="product_code" required class="form-control form-control-sm rounded-0" value="<?php echo isset($product_code) ? $product_code : '' ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="alert_restock" class="control-label">Alert quantite</label>
